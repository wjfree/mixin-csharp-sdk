...
namespace mixin_sdk_test
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            MixinWebSocketApi mixinWebSocketApi = new MixinWebSocketApi();
            mixinWebSocketApi.Init(USRCONFIG.ClientId, USRCONFIG.ClientSecret, USRCONFIG.SessionId, USRCONFIG.PinToken, USRCONFIG.PrivateKey);
            ...
            //            //Console.WriteLine(mixinMessagerApi.CreateAttachment());


            //            Console.WriteLine("\n\n======== Test Create Conversation ===========\n");
            //            //Console.WriteLine(mixinMessagerApi.CreateConversation("GROUP", users));

            ////            Console.WriteLine(mixinMessagerApi.CreateConversation("CONTACT", users));

            ////fd72abcd - b080 - 3e0e - bfea - a0b1282b4bd0
            //Console.WriteLine("\n\n======== Test Read Conversation ===========\n");
            //Console.WriteLine(mixinMessagerApi.ReadConversation("fd72abcd-b080-3e0e-bfea-a0b1282b4bd0"));

            var websocketclient = mixinWebSocketApi.WebSocketConnect().Result;

            mixinWebSocketApi.StartRecive(websocketclient).Wait();
